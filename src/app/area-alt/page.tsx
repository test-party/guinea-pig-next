        ...
        <div>
            <div>
                <img src="https://media.geeksforgeeks.org/wp-content/uploads/20190227165729/area11.png"
                    alt="Interactive shape map with triangle, circle, and rectangle" width="300" height="119"
                    useMap="#shapemap" />
                <map name="shapemap">
