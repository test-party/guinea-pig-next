    ...
    return (
        <div className="flex flex-col items-center justify-start p-8 space-y-4 !bg-blue-500 container children-test-container ">
            ...
            <div id="aria-command-name">
                ...
                <div>
                    ...
                    <div className="test-case-container">
                        ...
                        <div role="button" id="save-btn" aria-labelledby="sav-label" aria-label="Save Changes"></div>
                    ...
                    <div className="test-case-container">
                        ...
                        <div role="link" id="home-link" aria-labelledby="start-page" aria-label="Home">Home</div>
                        {/* Existing IDs in the DOM */}
                        <nav id="main-nav">...</nav>
                        <div id="content">...</div>
                    </div>
                    ...
                    <div className="test-case-container">
                        ...
                        <div role="link" id="contact-us-link" aria-labelledby="ContactUsHeading" aria-label="Contact Us"></div>
                        {/* Existing IDs in the DOM */}
                    ...
                    <div className="test-case-container">
                        ...
                        <div role="button" id="refresh-btn" aria-labelledby="" aria-label="Refresh Page"></div>
                        {/* Existing IDs in the DOM */}
                    ...
                    <div className="test-case-container">
                        ...
                        <div role="button" id="confirmation-dialog" aria-labelledby="dialog-title dialog-desc" aria-label="Confirm Action - Do you want to proceed?"></div>
                        {/* Existing IDs in the DOM */}
                    ...
                    <div className="test-case-container">
                        ...
                        <div role="button" id="confirmation-dialog2" aria-labelledby="dialog-title dialog-descriptions" aria-label="Confirm Action - Do you want to proceed?"></div>
                        {/* Existing IDs in the DOM */}
                        <h3 id="dialog-header2">Confirm Action</h3>
                        <p id="dialog-description2">Do you want to proceed?</p>
                    </div>
                </div>
            </div>
            <div >
                    ...
                    <div className="test-case-container">
                        ...
                        <article>
                            ...
                            <section>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#" id="related-article" aria-label="Related article link">Related Article</a></li>
                                </ul>
                            </section>
                        </article>
                        ...
                        <section>
                            ...
                            <form>
                                <fieldset>
                                    ...
                                    <div role="button" id="next-step" aria-label="Next step">Next</div>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <div role="button" id="prev-step" aria-label="Previous step">Previous</div>

                                    {/* Missing aria-label for the Submit button */}
                                    <div role="button" id="submit-form" aria-label="Submit form">Submit</div>
                                </fieldset>
                            </form>
                        </section>
                        ...
                        <section>
                            ...
                            <form>
                                ...
                                <div role="button" id="alempty" aria-label="Submit contact form">Submit</div>
                            </form>
                        </section>
                        ...
                        <section>
                            ...
                            <nav aria-label="Pagination">
                                ...
                                <div role="button" aria-label="Previous Page" id="prev-page">Previous</div>

                                {/* Missing aria-label for page number buttons */}
                                <div role="button" id="page-1" aria-label="Page 1">1</div>
                                <div role="button" id="page-2" aria-label="Page 2">2</div>
                                <div role="button" id="page-3" aria-label="Page 3">3</div>

                                {/* Properly labeled page button */}
                                <div role="button" aria-label="Next Page" id="next-page">Next</div>
                            </nav>
                        </section>
                        ...
                        <div role="dialog" aria-labelledby="modal-title" aria-describedby="modal-description">
                            ...
                            <div role="button" id="save-changes" aria-label="Save changes">Save</div>

                            {/* Properly labeled Cancel button */}
                            <div role="button" aria-label="Cancel" id="cancel">Cancel</div>

                            {/* Missing aria-label for the Close button */}
                            <div role="button" id="close-modal" aria-label="Close modal">Close</div>
                        </div>
                        ...
                        <nav>
                            ...
                            <ul role="menu" aria-label="User settings menu">
                                ...
                                <li role="menuitem" id="albmissing" aria-labelledby="nonexistent" aria-label="Account Settings">Account Settings</li>

                                {/* Failed example: aria-label is missing */}
                                <li role="menuitem" id="preferences" aria-label="Preferences">Preferences</li>
                            </ul>
                        </nav>
                ...
                Menu
                  ...
                  Home
                                ...
                                <div role="menuitem" id="mobile-services" aria-label="Services">Services</div>
                ...
                <div className="test-case-container">
                    ...
                    <div className="mb-4">
                        <div role="grid" className="border border-gray-300">
                            <div role="row" className="border-b">
            ...
            <div id="aria-treeitem-name">
                <div role="treeitem" aria-label="Tree item">Tree Item</div>

                <div role="treeitem" aria-label="Tree item with empty label">Tree Item</div>

                <div role="treeitem" aria-labelledby="nonexistent" aria-label="Tree item with missing reference">Tree Item</div>

                <div role="treeitem" aria-labelledby="emptydiv2" aria-label="Tree item with empty reference">Tree Item</div>
            ...
            <div id="aria-meter-name">
                ...
                <div className="test-case-container">
                    ...
                    <div role="meter" id="empty-meter" aria-label="Empty meter"></div>
                    <div role="meter" id="alempty-meter" aria-label="Meter with progress"></div>
                    <div role="meter" id="albmissing-meter" aria-labelledby="nonexistent" aria-label="Meter with missing reference"></div>
                    <div role="meter" id="albempty-meter" aria-labelledby="emptydiv3" aria-label="Meter with empty reference"></div>
                    <div id="emptydiv3"></div>
                    <div role="meter" id="valid-label-meter" aria-labelledby="valid-meter"></div>
                    <div id="valid-meter">Valid Label</div>
                </div>
            </div>
            <div id="aria-progressbar-name">
                <div role="progressbar" id="empty-progressbar" aria-label="Empty progress bar"></div>
                <div role="progressbar" id="alempty-progressbar" aria-label="Progress bar with empty label"></div>
                <div role="progressbar" id="albmissing-progressbar" aria-labelledby="nonexistent" aria-label="Progress bar with missing reference"></div>
                <div role="progressbar" id="albempty-progressbar" aria-labelledby="emptydiv4" aria-label="Progress bar with empty reference"></div>
                <div id="emptydiv4"></div>
                <div role="progressbar" id="valid-label-progressbar" aria-labelledby="valid-progressbar"></div>
                <div id="valid-progressbar">Valid Label</div>
            </div>
            <div id="aria-required-attr">
                ...
                <div className="test-case-container">
                    ...
                    <div role="combobox" aria-expanded="true" aria-controls="combobox-options" className={redDivStyle}></div>
                    <div id="combobox-options">Options list</div>
                    <p>No aria-controls attribute defined (aria-controls is required for "combobox" role)</p>
                    <div role="combobox" aria-expanded="true" aria-controls="combobox-options2" className={redDivStyle}></div>
                    <div id="combobox-options2">Options list</div>
                    ...
                    <div role="combobox" aria-controls="combobox-options3" aria-expanded="false" className={redDivStyle}></div>
                    <div id="combobox-options3">Options list</div>
                    ...
                    <div role="combobox" aria-controls="combobox-options4" aria-expanded="false" className={redDivStyle}></div>
                    <div id="combobox-options4">Options list</div>
                    <p>No aria-checked attribute (aria-checked is required for "switch" role)</p>
                    <div role="switch" aria-checked="false" className={redDivStyle}></div>
                    <p>No aria-checked attribute (aria-checked is required for "checkbox" role)</p>
                    <div role="checkbox" aria-checked="false" className={redDivStyle}></div>
                    ...
                    <div role="radio" aria-checked="false" className={redDivStyle}></div>
                    <p>No aria-valuemax,aria-valuemin,aria-valuenow attributes (all required for "scrollbar" role)</p>
                    <div role="scrollbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50" className={redDivStyle}></div>
                    <p>No aria-valuemax,aria-valuemin,aria-valuenow attributes (all required for "slider" role)</p>
                    <div role="slider" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50" className={redDivStyle}></div>
                </div>
            </div>
            ...
            <div id="aria-toggle">
                ...
                <div className="test-case-container">
                    ...
                    <div id="fail5" role="switch" aria-checked="true" aria-label="Toggle switch" className={redDivStyle}>
                        <span></span>
                        <span></span>
                    </div>
                </div>
            ...
            <div id="aria-valid-attr-value">
                ...
                >
                    ...
                    <div className={redDivStyle}>
                        ...
                        <input type="number" aria-valuemin="0" aria-label="Number input"></input>
                    </div>
                    <button role="tab" aria-selected="true" className={redDivStyle}>Element with role tab and wrong aria-selected attribute value.</button>
                    <div role="alert" aria-relevant="additions removals" className={redDivStyle}>aria-relevant with wrong values.</div>
                    <div aria-modal="false" className={redDivStyle}>aria-modal div with wrong value.</div>
                    <div>
                        ...
                        <button aria-details="more-info" className={blueButton}>Submit</button>
                    </div>
                    <div>
                        <div id="submit-button" className="my-2">This buttons access the submition (it has the wrong value on aria-owns attribute)</div>
                        <button aria-owns="submit-button" className={blueButton}>Click Me</button>
                    </div>
                </div>
            </div>
            ...
            <div id="blink-tag">
                ...
                <div className="test-case-container">
                    ...
                    <div className={redDivStyle}>Example blink-tag</div>
                </div>
            </div>
            <div id="button-name">
                <h2>Button-name</h2>
                ...
                <div className="test-case-container">
                    ...
                    <button role="button" className={redButton} aria-label="Subscribe">Subscribe</button>
                </div>
            </div>
            ...
            <div id="dlitem">
                <dl>
                    ...
                    <dd>Definition</dd>
                    <dt>Lonely Type</dt>
                    <dd>Definition for lonely type</dd>
                </dl>
            </div>
            <div id="frame-title">
                <iframe title="Passing Frame Title"><div>Frame Body</div></iframe>
                <iframe title="Invalid Frame"><div>Body of Invalid Frame</div></iframe>
            </div>
            <div id="frame-title-unique">
                <h1>Dashboard</h1>
                <iframe
                    srcDoc={reportHtml}
                    title="Monthly Report - First View"
                    width="400"
                    height="200"
                ...
                <iframe
                    srcDoc={reportHtml}
                    title="Monthly Report - Second View"
                    width="400"
                    height="200"
                    style={{ border: '1px solid black', marginTop: 20 }}
                />
                <iframe
                    srcDoc={reportHtml}
                    title="Monthly Report - Third View"
                    width="400"
                    height="200"
                    style={{ border: '1px solid black', marginTop: 20 }}
                />
            ...
            <div id="input-button-name">
                ...
                <div className="test-case-container">
                    ...
                    <form action="#">
                        <label id="submit-here">Submit Here</label>
                        <input type="button" aria-labelledby="submit-here" className={redDivStyle} />
                    </form>
                    <p>Button without any accessible name</p>
                    <form action="#">
                        <input type="button" id="first-name-btn" className={redDivStyle} value="Submit" />
                    </form>
                </div>
            </div>
            <div id="link-name">
                ...
                <div className="test-case-container">
                    ...
                    <a href="https://www.google.com" className={redDivStyle} aria-label="Visit Google">Visit Google</a>
                </div>
            </div>
            <div id="meta-refresh">
                <h2>Meta-refresh</h2>
            ...
            <div id="neurodiversity ruleset">
                ...
                <div className="test-case-container">
                    ...
                    <p>This text is mostly in english, <span lang="pt">mas essa parte é em portugues</span>, but the rest still in english</p>
                ...
                <div className="test-case-container">
                    ...
                    <p>He <dfn title="made unclear or hard to understand">obfuscated</dfn> it, now i can't see</p>
                    <p>His walk through the <dfn title="green with growing plants">verdant</dfn> garden surprised the visitors</p>
                    <p>This text is working well , no remediations needed </p>
                </div>
                <div className="test-case-container">
                    <h6>{'Abbreviations (abbreviations should be wrapped in an <abbr> tag with its meaning on title attribute)🚫'}</h6>
                    <p>The <abbr title="Federal Bureau of Investigation">FBI</abbr> is an american agency</p>
                    <p>The <abbr title="International Monetary Fund">IMF</abbr> is an american agency</p>
                    <p>This text is working well , no remediations needed </p>
                </div>
                <div className="test-case-container">
                    ...
                    <p>The temporary nature of understanding meaning requires complex thinking and careful study of hidden connections between ideas.</p>
                    <details>
                        <summary>Simpler version</summary>
                        <p>Understanding complex ideas takes time and careful thought about how ideas connect.</p>
                    </details>
                    <p>This text is working well , no remediations needed </p>
                </div>
                <div className="test-case-container">
                    <h6>Pronunciation (ambigous words should have his pronunciation detailed in the text)🚫</h6>
                    <p>I read <span title="pronounced: red (past tense)">read</span> the book today, it's amazing!</p>
                    <p>This text is working well , no remediations needed </p>
                </div>
            </div>
            <div id="role-img-alt">
                ...
                <div id="invalid-cases">
                    <div role="img" id="violation1" aria-label="Image description"></div>
                    <div role="img" aria-label="Image description" id="violation2"></div>
                    <div role="img" aria-labelledby="no-match" aria-label="Image description" id="violation3"></div>
                    <div role="img" title="Image title" id="violation4"></div>
                </div>
            </div>
            <div id="scrollable-region-focusable">
                ...
                <div className="flex flex-col md:flex-row gap-3 p-3">
                    ...
                    <div className="w-full max-w-[300px] h-[200px] overflow-auto bg-[#dcdcdc] p-2" tabIndex={0}>
                    ...
                    <div id="pass1" className="w-full max-w-[300px] h-[200px] overflow-y-auto bg-[#dcdcdc] p-2" tabIndex={0}>
            ...
            <div id="summary-name">
                ...
                <div className="test-case-container">
                    ...
                    <details>
                        <summary aria-labelledby="id-not-connecting-to-summary">Payment Instructions</summary>
                        <p>Please follow the payment instructions carefully.</p>
                    </details>

                    {/* aria-labelledby points to empty element */}
                    <h3>Returns and Exchanges</h3>
                    <p id="empty-label">Return policy information</p>
                    <details>
                        <summary aria-labelledby="empty-label">Returns and Exchanges</summary>
                    ...
                    <details>
                        <summary aria-label="Delivery Options">Delivery Options</summary>
                        <ul>
                    ...
                    <p id="empty-label2">Return policy details</p>
                    <details>
                        <summary aria-labelledby="empty-label2">Returns Policy</summary>
                        <p>Our return policy allows exchanges within 30 days.</p>
                    </details>
                </div>
            </div>
                ...
                <div >
                    <div onClick={() => { }} className="test-case-container">
                        ...
                        <svg
                            ...
                            width={40}
                            height={40}
                            aria-label="Robot character icon"
                        >
                            <rect
                                x="7"
                                y="21"
                    ...
                    <div className="test-case-container">
                        ...
                        >
                            <circle cx="24" cy="24" r="22" fill="#ffa221" strokeWidth="0"></circle>
                            <path
                                ...
                                strokeWidth="0"
                            ></path>
                            <circle cx="24" cy="24" r="20" fill="#ffc343" strokeWidth="0"></circle>
                            <path
                            ...
                            <path
                                ...
                                strokeWidth="0"
                            ></path>
                            <circle cx="24" cy="24" r="3" fill="#555e77" strokeWidth="0"></circle>
                        </svg>
                    </div>
                </div>
            </div>
                ...
                <div >
                    <div className="test-case-container">
                        ...
                        <div className="min-h-screen grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 p-6 md:p-24">
                            {ids.map((id) => {
                                return <div key={id}><img className="object-fill w-full h-full" key={id} src={`https://picsum.photos/id/${id}/200/300`} alt={`Random image ${id}`}></img></div>
                            })}
                        </div>
            ...
            <div id="aria-roles">
                ...
                <div >
                    <div className="test-case-container">
                        ...
                        <div role="button" className={redDivStyle}>
              Invalid role: "buttonish"
                        </div>
                        <div role="heading" aria-level="2" className={redDivStyle}>
              Invalid role: "headingg"
                        </div>
                        <div role="listbox" className={redDivStyle}>
              Invalid role: "select" (abstract role)
                        </div>
                        <span role="button" className={redDivStyle}>
              Invalid role: "superstar"
                        </span>

                        <nav className={redDivStyle}>
            ...
            <div id="aria-tooltip-name">
                ...
                <div >
                    <div className="test-case-container">
                        ...
                        <div role="tooltip" className={redDivStyle} aria-label="Tooltip information">
                        </div>
                        <div role="tooltip" aria-labelledby="missing-label" aria-label="Tooltip with missing reference" className={redDivStyle}>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="object-alt">
                ...
                <div className="test-case-container">
                    ...
                    <h3>Fail Cases:</h3>
                    <object data="path/to/content" aria-label="Content object">Content Object</object>
                    <object data="path/to/content" aria-label="Content with space"><div> </div></object>
                    <object data="path/to/content" aria-label="Object with alternative text">This object has no alternative text.</object>
                </div>
            </div>
            <div id="frame-focusable-content">
                <h2>Frame-focusable-content</h2>
                ...
                <div className="test-case-container">
                    ...
                    <iframe
                        srcDoc='<div>No focusable content</div>'
                        tabIndex={-1}
                ...
                <div id="aria-input-field-name">
                    ...
                    <div >
                        <div className="test-case-container">
                            ...
                            <div>
                                <div id="fail2" aria-labelledby="non-existing" role="combobox" aria-label="Wrong input field" aria-expanded="false" aria-controls="combobox-list">Wrong input field</div>
                                <div id="combobox-list">Options</div>
                            </div>
                        </div>
                    </div>
                </div>
